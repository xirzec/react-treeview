...
const Immutable = __webpack_require__(75);
exports.ROOT_ID = "ROOT";
exports.EMPTY_CHILD_LIST = Immutable.OrderedSet();
exports.INITIAL_ROOT_NODE = Object.freeze({
    id: exports.ROOT_ID,
    updateCount: 0,
    children: exports.EMPTY_CHILD_LIST,
    parent: "",
});
exports.INITIAL_TREE_STATE = Immutable.Map({
    [exports.ROOT_ID]: exports.INITIAL_ROOT_NODE,
});
...
const treeItem_1 = __webpack_require__(78);
class TreeLevel extends React.PureComponent {
    render() {
        const style = this.props.isRoot ? {} : nestedStyle;
        return React.createElement("div", { style: style }, this.getItems());
    }
    getItems() {
        ...
        return this.props.items.map(item => {
            return (React.createElement(treeItem_1.default, { key: item.id, item: item, map: this.props.map, onItemClick: this.props.onItemClick, sizeForExpandable: someChildExpandable }));
        });
    }
}
...
class Icon extends React.PureComponent {
    ...
    render() {
        return (React.createElement("svg", { style: this.props.style, fill: "currentColor", height: this.props.height, width: this.props.width, viewBox: "0 0 448 448", onClick: this.handleClick, focusable: "false" }, this.getIcon()));
    }
}
Icon.defaultProps = {
    height: 14,
...
const store_1 = __webpack_require__(72);
const main_1 = __webpack_require__(76);
...
const redux_thunk_1 = __webpack_require__(73);
const reducers_1 = __webpack_require__(74);
const store = redux_1.createStore(reducers_1.default, redux_1.compose(redux_1.applyMiddleware(redux_thunk_1.default)));
...
function node(state = constants_1.INITIAL_TREE_STATE, action) {
    switch (action.type) {
        case "UPDATE_NODE": {
            const current = state.get(action.id);
            const updatedNode = Object.assign({}, current);
        ...
        case "ADD_CHILD": {
            ...
            const newNode = {
                id: nextNodeId(),
                children: constants_1.EMPTY_CHILD_LIST,
                updateCount: 0,
                parent: parent.id,
            };
        ...
        case "REMOVE_NODE": {
            if (action.id === constants_1.ROOT_ID) {
                return state;
            }
            const current = state.get(action.id);
            const parent = state.get(current.parent);
            const updatedNode = Object.assign({}, parent);
...
const React = __webpack_require__(1);
const react_redux_1 = __webpack_require__(18);
const actions_1 = __webpack_require__(77);
const constants_1 = __webpack_require__(29);
const treeLevel_1 = __webpack_require__(30);
class Main extends React.PureComponent {
    ...
    render() {
        const root = this.props.nodes.get(constants_1.ROOT_ID);
        return (React.createElement("div", null,
            React.createElement("p", null, "Click nodes to expand/collapse them."),
            React.createElement("p", null, "Alt-Click to update a node."),
            React.createElement("p", null, "Shift-Click to add a child."),
            React.createElement("p", null, "Ctrl-Click to remove a node."),
            React.createElement(treeLevel_1.default, { map: this.props.nodes, items: [root], onItemClick: this.onNodeClick })));
    }
}
exports.Main = Main;
...
function mapDispatchToProps(dispatch) {
    return {
        onAddChild: id => dispatch(actions_1.addChild(id)),
        onRemoveNode: id => dispatch(actions_1.removeNode(id)),
        onUpdateNode: id => dispatch(actions_1.updateNode(id)),
    };
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const treeCollapsed_1 = __webpack_require__(79);
const treeExpanded_1 = __webpack_require__(80);
const treeLevel_1 = __webpack_require__(30);
class TreeItem extends React.PureComponent {
    ...
    render() {
        ...
        if (hasChildren && expanded) {
            icon = React.createElement(treeExpanded_1.default, null);
            footer = React.createElement("div", { style: { marginLeft: 16 } }, "<node>");
            child = (React.createElement(treeLevel_1.default, { map: this.props.map, items: this.getChildren(), isRoot: false, onItemClick: this.props.onItemClick }));
        }
        else if (hasChildren) {
            icon = React.createElement(treeCollapsed_1.default, null);
        }
        else {
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const icon_1 = __webpack_require__(31);
class TreeCollapsedIcon extends icon_1.Icon {
    getIcon() {
        return React.createElement("path", { d: "M160 352.438v-256.908l135.22 128.47-135.22 128.438zm32-182.375v107.875l56.766-53.938-56.766-53.937z" });
    }
}
exports.default = TreeCollapsedIcon;
...
const React = __webpack_require__(1);
const icon_1 = __webpack_require__(31);
class TreeExpandedIcon extends icon_1.Icon {
    getIcon() {
        return React.createElement("path", { d: "M320 128v192h-192l192-192z" });
    }
}
exports.default = TreeExpandedIcon;


/***/ })
/******/ ]);
//# sourceMappingURL=app.98df8f7058a236a72795.map